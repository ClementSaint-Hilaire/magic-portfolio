...
const BentoCard = ({
  ...
  >
    ...
    <div
      className={cn(
        "bg-gradient-to-b from-transparent to-black/50 pointer-events-none absolute bottom-0 flex w-full translate-y-10 transform-gpu flex-row items-center p-9 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100",
      )}
    >

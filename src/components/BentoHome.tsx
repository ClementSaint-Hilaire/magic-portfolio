...
const features = [
  {
    name: "Templates",
    description: "Retrouvez ma suite de templates Notion, Slides et Figma.",
    href: "/templates",
    cta: "Découvrir",
      ...
      >
        {works.map((f, idx) => (
         <figure
            ...
            className={cn(
              "relative w-[25rem] h-[14rem] cursor-pointer overflow-hidden p-4",
              "bg-cover bg-center hover:bg-gray-950/[.05]",
  ...
  href: "https://www.figma.com/community/file/1412017477167007912/csh-icons",
  cta: "Découvrir",
  className: "col-span-3 lg:col-span-1",
  background: (
    <Marquee
      pauseOnHover
      className="top-10 [--duration:20s] " 
    >
      {icons.map((f, idx) => (
         <figure
         key={idx}
         className={cn(
           "relative w-24 h-48 cursor-pointer overflow-hidden p-4 flex",
           "transform-gpu transition-all duration-300 ease-out",
         )}
       >
      {f.svg}
...
{
  name: "ACL Studio",
  description: "Transformez votre présence en ligne pour augmenter votre visibilité.",
  href: "https://aclstudio.fr",
  cta: "Découvrir",
  className: "col-span-3 lg:col-span-2",
  background: (
    <img src="/aclstudio.png"/>
  ),
},
{
  name: "Design System",
  description: "Profitez d'une bibliothèque qualitative et complète.",
  href: "https://www.figma.com/community/file/1412016153426631847/csh-design-system",
  cta: "Découvrir",
  className: "col-span-3 lg:col-span-2",
  background: (
    <img src="/designSystem.png"/>
  ),
},
{
  name: "",

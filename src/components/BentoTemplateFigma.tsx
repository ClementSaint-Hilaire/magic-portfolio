...
const features = [
  {
    ...
    background: (       
      <img src="/templates/figma/furnitureAgency.png"/>
    ),
  },
  {
    ...
    className: "col-span-3 lg:col-span-3",
    background: (       
      <img src="/templates/figma/darkPortfolio.png"/>
    ),
  },
  {
    name: "The Blog",
    ...
    className: "col-span-3 lg:col-span-3",
    background: (       
      <img src="/templates/figma/blog.png"/>
    ),
  },
  {
    ...
    className: "col-span-3 lg:col-span-3",
    background: (       
      <img src="/templates/figma/uiUxPortfolio.png"/>
    ),
  },
  {
    name: "404 pages",
    ...
    className: "col-span-3 lg:col-span-3",
    background: (       
      <img src="/templates/figma/404.png"/>
    ),
  },

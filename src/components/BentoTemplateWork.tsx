...
const features = [
  ...
  },
  {
    ...
    className: "col-span-3 lg:col-span-3",
    background: (       
      <img src="/works/croissantage.png"/>
    ),
  },
  {
    name: "Retropizza.fr",
